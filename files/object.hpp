...
struct Object {
	...
	tarray(f3, 3) transform(maybe<f3> location, maybe<f3> rotation, maybe<f3> scale) const;
	tarray(f3, 3) transform_mutable(maybe<f3> location, maybe<f3> rotation, maybe<f3> scale);

	tarray(f3, 3) transform_delta(maybe<f3> delta_location, maybe<f3> delta_rotation, maybe<f3> delta_scale) const;
	tarray(f3, 3) transform_delta_mutable(maybe<f3> delta_location = none, maybe<f3> delta_rotation = none, maybe<f3> delta_scale = none);
